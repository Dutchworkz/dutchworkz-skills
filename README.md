...
1. Add the marketplace:
   ```
   /plugin marketplace add Dutchworkz/dutchworkz-skills
   ```
2. Install a plugin:
   ```
...
// settings.json
{
  ...
  "chat.plugins.marketplaces": ["Dutchworkz/dutchworkz-skills"]
}
```
...
1. Add the marketplace:
   ```bash
   codex plugin marketplace add Dutchworkz/dutchworkz-skills
   ```
2. Launch Codex and open the plugin browser:
   ```
   /plugins
   ```
3. Browse the `dutchworkz-skills` tab and install the desired plugins.
